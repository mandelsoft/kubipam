...
import (
	...
	"github.com/mandelsoft/kubipam/pkg/client/ipam/clientset/versioned/scheme"
...
// IpamV1alpha1Client is used to interact with features provided by the ipam.mandelsoft.org group.
type IpamV1alpha1Client struct {
	restClient rest.Interface
}

func (c *IpamV1alpha1Client) IPAMRanges(namespace string) IPAMRangeInterface {
	return newIPAMRanges(c, namespace)
}

func (c *IpamV1alpha1Client) IPAMRequests(namespace string) IPAMRequestInterface {
	return newIPAMRequests(c, namespace)
}
